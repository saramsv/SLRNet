...
class DecomTrainDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        #each item in batch_records is one line from the input file
        #each line in the input, when we have sequences, has 3 images
        seq_len = len(batch_records[0]['fpath_img'])
        ...
        batch_images = torch.zeros(
            self.batch_per_gpu * seq_len, 3, batch_height, batch_width)
        ...
        for i in range(self.batch_per_gpu):
            ...
            all_img_paths = this_record['fpath_img']
            all_segm_paths = this_record['fpath_segm']
            for j in range(seq_len):
                ...
                batch_segms[i*seq_len + j][:segm.shape[0], :segm.shape[1]] = segm
...
class TrainDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        for i in range(self.batch_per_gpu):
            ...
            ## Sara added to handel the few pixel difference 
            if abs(img.size[0] - segm.size[0]) < 5:
